...
public class PessoaFisica extends JFrame{
	...
	public PessoaFisica(){
		...
		paine.add(cep);
		paine.add(txtCep);			
		cep.setBounds(335, 65, 40, 30);
		txtCep.setBounds(400, 65, 120, 30);
		...
		rdbsexo[0].setBounds(395, 15, 85, 30);
		paine.add(rdbsexo[1]);
		rdbsexo[1].setBounds(480, 15, 90, 30);
		...
		paine.add(btnSalvar);
		btnSalvar.setBounds(310, 250, 100, 30);
		
		paine.add(btnImprimir);
		btnImprimir.setBounds(150, 250, 100, 30);
